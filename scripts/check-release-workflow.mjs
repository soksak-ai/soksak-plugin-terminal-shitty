...
requireText("node-version-file: soksak-plugins/soksak-plugin-terminal-shitty/.node-version", "Node owner");
requireText("package_json_file: soksak-plugins/soksak-plugin-terminal-shitty/frontend/package.json", "pnpm owner");
